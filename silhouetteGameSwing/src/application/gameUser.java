...
public class gameUser extends Thread {
  ...
  List<String> Images; // 랜덤 이미지를 가져오는 필드
  ...
  final String gameAnswer = "ANSWER"; // 정답맞출시
    ...
    try {
      ...
      while (true) {
        ...
        /* 게임 시작 */
          ...
          System.out.println("[Server] 게임 시작!");
        ...
        /* 게임 스킵 */
          ...
          System.out.println("[Server] 게임 스킵!");
          firstLoadImg(new File("resource"));
          String image = loadRandomImages();
        ...
        /* 게임 정답 */
          ...
          System.out.println("[Server] 게임 정답!");
          firstLoadImg(new File("resource"));
          String image = loadRandomImages();
        ...
        /* 게임 끝 */
          ...
          System.out.println("[Server] 게임 끝");
          sendRoom(gameEnd + "//");
        }
        /* 게임 끝 */
